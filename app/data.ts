...
import { siNodedotjs, siNextdotjs, siTypescript, siDocker, siGit } from 'simple-icons';
...
export const skills: Skill[] = [
  { 
    name: 'Node.js', 
    description: 'Most of my things are made with this', 
    iconPath: siNodedotjs.path,
    color: 'text-green-500' 
  },
  { 
    name: 'Next.js', 
    description: "Frontend stuff (Don't have much experience yet)", 
    iconPath: siNextdotjs.path,
    color: 'text-white' 
  },
  { 
    name: 'TypeScript', 
    description: 'Backend stuff (for this site only for now...)', 
    iconPath: siTypescript.path,
    color: 'text-blue-500' 
  },
  { 
    name: 'Docker', 
    description: 'Container stuff ig', 
    iconPath: siDocker.path,
    color: 'text-blue-400' 
  },
  { 
    name: 'Java', 
    description: 'I... Just use it', 
